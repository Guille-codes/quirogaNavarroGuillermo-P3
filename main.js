...
listaPrenda.innerHTML += ` <li>‎ ‎ ‎ ‎ Marcas mundialmente conocidas</li>`
        ...
        function borrarItemTienda(array) {
            // Obtenemos el producto ID que hay en el boton pulsado
            const id = array.target.dataset.item;
            // Borramos todos los productos
            tienda = tienda.filter((tiendaId) => {
                return tiendaId !== id;
            });
        ...
        let {id, prenda, precio, talle, imagen} = prenda1
        console.log(id)
        console.log(prenda)
        console.log(precio)
        console.log(talle)
        ...
        const {prenda:title, precio:price, talle:waist} = prenda2
        console.log(title)
        console.log(price)
        console.log(waist)
        ...
        console.log(a.prenda)

        const numeros = [4, 77, 92, 10, 3, -32, 54, 111, 5000, 44999]
